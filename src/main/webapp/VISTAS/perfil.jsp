	...
	<header class="header-section">
		<div class="container">
			...
			<div class="user-panel" style="position: absolute; top: 75px; left: 1060px; background: yellow; border-style: inset;">
				<a href="VISTAS/juegos.jsp" style="font-size: 17px;">Mi cuenta</a>
			</div>
			<!-- responsive -->
			...
			<div class="container">
				<div class="row">
					<div class="col-xl-5 col-lg-6 text-black">
						...
						<p>Tu información de socio <br> ¿No recuerdas tu clave? Mírala y apúntala
						<br>¿Has descargado algún juego? Aquí tienes todo tu historial</p>
					</div>
				</div>
			</div>
		</div>
