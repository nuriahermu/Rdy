...
<body>
			...
			<div class="container">
				<div class="row">
					<div class="col-xl-5 col-lg-6 text-white">
						<h2>Contáctanos</h2>
						<p>Si tiene alguna duda con algún producto, novedad, o
							requiere información de alguno de nuestros juegos no dude en
	...
	<section class="page-section spad contact-page">
		<div class="container">
			...
			<div>
				<h4>¡Ven a conocernos, también disponemos de tienda física!</h4>
			</div>
			<hr>
			<hr>
			<div class="row">
				...
				<div class="row">
					<div class="col-md-9">
						<ul class="contact-info-list">
							<li><div class="cf-left">Dirección</div>
								<div class="cf-right">Av. del Cardenal Cisneros, s/n,
									49023 Zamora</div></li>
							<li><div class="cf-left">Teléfono</div>
