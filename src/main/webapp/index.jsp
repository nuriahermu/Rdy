    ...
    <div class="container">
      <div class="card login-card">
        <div class="row no-gutters">
          <div class="col-md-5">
            <img src="ESTILOS/login/images/login2.jpg" alt="login" class="login-card-img">
          </div>
          <div class="col-md-7">
            <div class="card-body">
              ...
              <form action="rdyControllerUsuarios?action=index" method="post">               
                ...
                <p class="login-card-footer-text">¿No tienes cuenta? <a href="VISTAS/nuevoUsuario.jsp" class="text-reset">Registrate aquí</a></p>
