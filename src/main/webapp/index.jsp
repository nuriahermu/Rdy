									...
									<div class="modal-dialog">
										<div class="modal-content">
											<div class="modal-body" style="overflow-y: scroll;">
												...
												total del usuario, que est&aacute; sujeto a la
												aceptaci&oacute;n de los presentes t&eacute;rminos y
												condiciones de uso, de la pol&iacute;tica de privacidad y el
												uso de los datos aqu&iacute; transcritos. El uso de este
												sitio web y las relaciones entre EDP y los usuarios se rigen
												por la legislaci&oacute;n portuguesa aplicable. EDP se
												reserva el derecho de cambiar los presentes t&eacute;rminos
												y condiciones de uso o revisar la pol&iacute;tica de
												privacidad y uso de datos en los presentes identificados
												siempre que lo considere oportuno, en cualquier momento, con
												o sin previo aviso. Para consultar su versi&oacute;n actual,
												haga clic en los "T&eacute;rminos y condiciones de uso" que
												se encuentran en el sitio web de EDP. La versi&oacute;n
												m&aacute;s actual de los T&eacute;rminos y condiciones de
												uso sustituye todas las versiones anteriores. Si no
												est&aacute; de acuerdo con estos T&eacute;rminos y
												condiciones de uso, no utilice el sitio web. Estos
												T&eacute;rminos y condiciones de uso y la Pol&iacute;tica de
												privacidad constituyen un contrato entre el usuario y EDP, y
												se aplican en el uso del sitio web. Es responsabilidad del
												usuario leer y revisar los mismos cada vez que accede al
												sitio web, con el fin de conocer cualquier cambio realizado,
												ya que los mismos afectan a sus derechos. <br> 2.
												DERECHOS DE PROPIEDAD INTELECTUAL Los contenidos que
												aparecen en el sitio web, incluyendo, sin limitaci&oacute;n,
												...
												informaci&oacute;n y uso personal y no puede ser utilizado,
												...
												aplicaci&oacute;n. Sin embargo, el usuario podr&aacute;
												imprimir el material contenido en este sitio web, siempre
												que el mismo no se modifique, sea para uso personal y no
												comercial, y mantenga la indicaci&oacute;n de la fuente y de
												los derechos de autor, y siempre que no se elimine ninguna
												otra indicaci&oacute;n de propiedad. Nada en este sitio web
												deber&aacute; interpretarse como una concesi&oacute;n de
												cualquier tipo de licencia u otra autorizaci&oacute;n de uso
												a sus usuarios. El sitio web puede contener im&aacute;genes
												u otros materiales cuyos derechos de autor pertenecen a
												terceros, tal como proveedores u otras entidades que
												contribuyan a su creaci&oacute;n o mantenimiento (como por
												ejemplo, fotos de banco de im&aacute;genes). A pesar de que
												los datos personales proporcionados a EDP est&aacute;n
												protegidos de acuerdo a lo definido en la Pol&iacute;tica de
												privacidad y uso de datos que aparecen en los presentes
												T&eacute;rminos y condiciones de uso, cualquier
												informaci&oacute;n u otro contenido que el usuario transmita
												a trav&eacute;s de este sitio web, ya sea mediante correo
												electr&oacute;nico, env&iacute;o de archivos o de algún otro
												modo, se considerar&aacute; como no confidencial y no
												reservado.<br> 3. CONTENIDOS Y GARANTIAS El usuario
												acepta que el uso del sitio web debe hacerse bajo su propia
												cuenta y riesgo. En la medida en que lo permita la ley, EDP,
												...
												responsabilidad u obligaci&oacute;n por cualquier (i) error
												o contenido poco preciso, (ii) daño personal o daño a la
												...
												sitio web.<br> 4. RESPONSABILIDAD, USO Y RIESGO En la
												medida en que sea permitido por la ley, EDP y todos sus
												representantes legales, directores, empleados u otros que
												por cualquier forma actúen en nombre y representaci&oacute;n
												de EDP, as&iacute; como cualquier otra parte involucrada en
												la creaci&oacute;n, producci&oacute;n, mantenimiento o
												...
												leyes locales.<br> 5. POLITICA DE PRIVACIDAD Y USO DE
												DATOS EDP es responsable por el uso de la informaci&oacute;n
												personal de los usuarios recogida directamente a
												trav&eacute;s de diversos medios. EDP se compromete a poner
												en pr&aacute;ctica las medidas t&eacute;cnicas y
												organizativas adecuadas para proteger los datos personales
												de sus usuarios contra su destrucci&oacute;n, accidental o
												il&iacute;cita, p&eacute;rdida accidental,
												modificaci&oacute;n, divulgaci&oacute;n o acceso no
												autorizado. Se considera la aplicaci&oacute;n de un nivel de
												seguridad acorde con los riesgos que implica el uso dada la
												naturaleza de los datos a proteger. Por tanto, EDP puede
												recoger y guardar informaci&oacute;n que le haya sido
												suministrada de manera voluntaria y con consentimiento,
												incluyendo, entre otros, informaci&oacute;n personal
												individualizada, como el nombre, direcci&oacute;n,
												direcci&oacute;n de correo electr&oacute;nico y el número de
												tel&eacute;fono. EDP antes del uso y recogida de los datos
												personales directamente de los respectivos titulares,
												proporcionar&aacute; toda la informaci&oacute;n necesaria
												relativa al uso y recoger&aacute; la autorizaci&oacute;n
												respectiva para tal fin. Los datos proporcionados por los
												usuarios ser&aacute;n utilizados por EDP de conformidad con
												los preceptos legalmente aplicables, en particular: a)
												Utilizados de forma l&iacute;cita y respetando el principio
												de buena fe; b) Recogidos con fines determinados,
												expl&iacute;citos y leg&iacute;timos, no pudiendo ser
												utilizados posteriormente; c) Exactos y, de ser necesario,
												actualizados, debiendo tomarse las medidas adecuadas para
												asegurar que sean eliminados o rectificados los datos
												inexactos o incompletos, teniendo en cuenta el fin para el
												que fueron recogidos o para los que son tratados
												posteriormente; d) Conservados para permitir la
												identificaci&oacute;n de sus titulares solamente durante el
												per&iacute;odo necesario para alcanzar los fines de recogida
												o uso posterior. Los datos solicitados en el sitio web no
												son considerados, a la luz de la legislaci&oacute;n
												aplicable, como datos sensibles y, por lo tanto, no se
												aplican las inherentes restricciones. Los datos personales
												del usuario son recogidos e introducidos por EDP en un
												archivo automatizado para llevar a cabo actividades
												...
												legales, no utilice el sitio web. <br> 7. SEGURIDAD Y
												USO DE LA INFORMACI&Oacute;N EDP se compromete a garantizar
												la privacidad de los usuarios registrados. EDP no vende ni
												...
												por la ley. La conservaci&oacute;n de esa informaci&oacute;n
												permite que EDP siga proporcionando servicios personalizados
												sin interrupci&oacute;n. <br> 9. TRANSMISI&Oacute;N
												Estos T&eacute;rminos y condiciones de uso y cualquier
												derecho y licencia por el presente concedidos, no pueden ser
												transferidos o cedidos por el usuario, pudiendo, sin
												embargo, ser atribuidos por EDP a terceros sin
												restricci&oacute;n alguna.<br> 10. LEY APLICABLE Los
												presentes T&eacute;rminos y condiciones de uso y la
												Pol&iacute;tica de privacidad se rigen por la
												legislaci&oacute;n portuguesa y se interpretar&aacute;n de
												acuerdo a la misma. La versi&oacute;n en portugu&eacute;s de
												los presentes T&eacute;rminos y condiciones de uso y de la
												Pol&iacute;tica de privacidad, prevalecer&aacute;n sobre
												cualquier traducci&oacute;n a otros idiomas, si las hubiera.
												La nulidad de alguna de las disposiciones tendr&aacute; que
												ser eliminada, quedando las restantes disposiciones del
												mismo en vigor &iacute;ntegramente y produciendo sus
												efectos. En la falta de un acuerdo amigable entre las
												partes, los conflictos y disputas de cualquier naturaleza,
												relacionados con la formaci&oacute;n, aplicaci&oacute;n o
												interpretaci&oacute;n del presente Contrato, ser&aacute;n
												regidos por la ley de Portugal y sujetos a la
												jurisdicci&oacute;n del Tribunal Judicial da Comarca de
												Lisboa, con renuncia expresa a cualquier otro.
											</div>
